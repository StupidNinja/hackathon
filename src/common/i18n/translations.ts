export const translations = {
  ru: {
    ...
    "admin.settings.durationCheckpoint": "Чекпоинт",
    "admin.settings.durationMinutes": "Длительность (мин)",
    "admin.settings.durationHoursMinutes": "Часы и минуты",
    "admin.settings.durationMinutesHint": "Общая длительность этапа",
    "admin.settings.durationSplitHint": "Тот же ввод в формате ч/мин",
    "admin.settings.durationHoursShort": "Часы",
    "admin.settings.durationMinutesShort": "Минуты",
    ...
    "admin.settings.offsetsTitle": "Отступы чекпоинтов от T0",
    "admin.settings.offsetsDesc":
      "Настройте минуты открытия и дедлайна для каждого чекпоинта относительно нулевого времени.",
    "admin.settings.offsetsCheckpoint": "Чекпоинт",
    "admin.settings.offsetsOpen": "Открытие (мин)",
    "admin.settings.offsetsDue": "Дедлайн (мин)",
    "admin.settings.offsetsSave": "Сохранить отступы",
    "admin.settings.offsetsSaveSuccess": "Отступы чекпоинтов сохранены.",
    "admin.settings.offsetsInvalidRange":
      "Для {{checkpoint}} дедлайн не может быть раньше времени открытия.",
