export const translations = {
  ru: {
    ...
    "dashboard.disqualification.title": "Команда дисквалифицирована",
    "dashboard.disqualification.reason": "Причина",
    ...
    "hackathon.form.disqualified": "Команда дисквалифицирована.",
    ...
    "admin.teams.actions.disqualify": "Дисквалифицировать",
    ...
    "admin.teams.filter.disqualified": "Дисквалифицированы",
    "admin.teams.disqualify.title": "Дисквалифицировать команду",
    "admin.teams.disqualify.description":
      "Укажите причину дисквалификации. Капитан увидит ваш комментарий.",
    ...
    "admin.teams.disqualify.commentPlaceholder":
      "Объясните причину дисквалификации...",
    "admin.teams.disqualify.commentMinLength": "Минимум 5 символов",
    "admin.teams.disqualify.confirm": "Дисквалифицировать",
    "admin.teams.disqualify.success": "Команда дисквалифицирована.",
    "admin.teams.disqualify.error": "Не удалось дисквалифицировать команду.",
    ...
    "admin.teams.details.disqualification.section": "Дисквалификация",
    "admin.teams.details.disqualification.disqualifiedBy": "Дисквалифицировал:",
    ...
    "admin.checkpoints.reject.desc": "Команда будет дисквалифицирована. Капитан увидит причину.",
    ...
    "admin.checkpoints.reject.reason.cp0.no_confirmation": "Не подтвердили участие",
    "admin.checkpoints.reject.reason.cp0.invalid_topic": "Некорректная тема",
    "admin.checkpoints.reject.reason.cp0.other": "Другое",
    "admin.checkpoints.reject.reason.cp1.incomplete_description": "Неполное описание",
    ...
    "admin.checkpoints.reject.reason.cp2.invalid_repo": "Некорректный репозиторий",
    "admin.checkpoints.reject.reason.cp2.no_implementation": "Нет реализации",
    "admin.checkpoints.reject.reason.cp2.other": "Другое",
    "admin.checkpoints.reject.reason.cp3.no_build": "Нет финальной сборки",
    "admin.checkpoints.reject.reason.cp3.no_presentation": "Нет презентации",
